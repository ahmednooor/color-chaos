...
//        randomv,
//        i;
//    //randomv = Math.round(randomv);
//    function loop() {
//        divs[i] = document.createElement("div");
//        divs[i].classList.add("pattern-divs");
//        randomv = Math.floor((Math.random() * 10) + 1);
//        if (randomv <= 1) {
//            divs[i].style.background = "orangered";
//        } else if (randomv <= 2) {
//            divs[i].style.background = "royalblue";
//        } else if (randomv <= 3) {
//            divs[i].style.background = "limegreen";
//        } else if (randomv <= 4) {
//            divs[i].style.background = "crimson";
//        } else if (randomv <= 5) {
...
//        } else if (randomv <= 10) {
//            divs[i].style.background = "#FF858A";
//        }
//        container.appendChild(divs[i]);
//    }
//
